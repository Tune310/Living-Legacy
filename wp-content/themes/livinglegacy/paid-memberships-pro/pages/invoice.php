	...
	{ 
		...
		<div class="pmpro_invoice_details">
			...
			<?php } ?>
                        ...
                        <?php // if(!empty($pmpro_invoice->AA_FirstName)) { ?>
			<div class="pmpro_invoice-billing-address">
				<strong><?php _e('Billing Address', 'paid-memberships-pro' );?></strong>
				<p><?php echo $pmpro_invoice->AA_FirstName.' '.$pmpro_invoice->AA_LastName?><br />
				<?php echo $pmpro_invoice->AA_Address1?><br />						
				<?php if($pmpro_invoice->AA_city && $pmpro_invoice->AA_state) { ?>
					<?php echo $pmpro_invoice->AA_city?>, <?php echo $pmpro_invoice->AA_state?> <?php echo $pmpro_invoice->AA_zipcode?> <?php echo $pmpro_invoice->billing->country?><br />												
				<?php } ?>
				<?php echo formatPhone($pmpro_invoice->AA_phone)?>
				</p>
			</div> <!-- end pmpro_invoice-billing-address -->
                        <?php // } ?>
